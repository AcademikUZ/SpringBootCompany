...
import com.example.companyinspringboot.services.WorkerService;
...
public class WorkerController {
    ...
    @GetMapping("/getall")
    public ResponseEntity<Page<Worker>> getAll(@RequestParam Integer page) {
        Page<Worker> all = service.getAll(page);
    ...
    public ResponseEntity<?> update(@Valid @PathVariable Long id, @RequestBody WorkerDto workerDto) {
        ApiResult apiResult = service.update(id, workerDto);
    ...
    public ResponseEntity<?> add(@Valid @RequestBody WorkerDto workerDto) {
        ApiResult apiResult = service.add(workerDto);
